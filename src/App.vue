<template>
  <div class="flex flex-col h-screen bg-neutral-100 font-sans">
    <!-- Navbar -->
    <nav class="bg-black text-white px-8 py-2">
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <div :class="['p-8 overflow-y-auto', showRightSection ? 'w-full lg:w-8/12' : 'w-full']">
        ...
        <div
          class="bg-white border border-gray-300 rounded-lg h-96 flex justify-center items-center mb-8"
        >
...
const analyzeImage = async (imageData) => {
  ...
  try {
    ...
    if (
      ...
      if (content && content.overallScore && content.categories) {
